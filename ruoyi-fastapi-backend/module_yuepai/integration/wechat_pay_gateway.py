...
class WechatPayGateway:
    ...
    async def prepare_jsapi(
        ...
        *,
        ...
        invoke_params = self._mini_program_invoke_params(prepay_id)
        return {'prepayId': prepay_id, 'invokeParams': invoke_params}
    ...
    async def request_refund(
        ...
        *,
        ...
        payload = {
            ...
            'reason': reason[:80],
            'notify_url': self.settings.yuepai_wechat_pay_notify_url.replace('/payment/', '/refund/'),
    ...
    def _mini_program_invoke_params(self, prepay_id: str) -> dict[str, str]:
        ...
        message = (
            f'{self.settings.yuepai_wechat_pay_app_id}\n{timestamp}\n{nonce}\n{package_value}\n'
        ).encode()
