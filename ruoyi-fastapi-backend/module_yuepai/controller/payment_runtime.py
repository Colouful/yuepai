...
payment_runtime = APIRouterPro(prefix='/yuepai/payments', order_num=33, tags=['91约拍Pro-支付回调'])
payment_runtime.add_api_route('/wechat/notify', payment_notify, methods=['POST'], summary='微信支付结果回调')
