<template>
  <view class="min-h-full bg-white px-5 py-8">
    <view class="mb-6 text-center">
      <text class="text-xl font-bold text-slate-900">用户协议</text>
    </view>

    <view class="space-y-6 text-justify text-sm leading-relaxed text-slate-600">
      <view>
        <text class="mb-2 block font-bold text-slate-800"
          >1. 服务条款的确认和接纳</text
        >
        <text
      ...
      <view>
        <text class="mb-2 block font-bold text-slate-800">3. 用户行为规范</text>
        <text
      ...
      <view>
        <text class="mb-2 block font-bold text-slate-800">5. 知识产权声明</text>
        <text
      ...
      <view>
        <text class="mb-2 block font-bold text-slate-800">6. 免责声明</text>
        <text
