<template>
  <view class="min-h-full bg-white px-5 py-8">
    <view class="mb-6 text-center">
      <text class="text-xl font-bold text-slate-900">隐私协议</text>
    </view>
    ...
    <view class="space-y-6 text-justify text-sm leading-relaxed text-slate-600">
      ...
      <view>
        <text class="mb-2 block font-bold text-slate-800">4. 您的权利</text>
        <text
      ...
      <view>
        <text class="mb-2 block font-bold text-slate-800">6. 联系我们</text>
        <text
