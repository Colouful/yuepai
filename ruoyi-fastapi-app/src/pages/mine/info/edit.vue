    ...
    <view class="space-y-5">
      ...
      <view class="group relative">
        ...
        <input
          ...
          class="h-11 w-full rounded-xl bg-stone-50 px-4 text-sm text-slate-800 outline-none ring-1 ring-slate-200 transition-all focus:bg-white focus:ring-2 focus:ring-amber-400/50"
          type="text"
          placeholder="请输入昵称"
        />
      </view>
      ...
      <!-- Email -->
      <view class="group relative">
        <text class="mb-2 block text-sm font-medium text-slate-700">邮箱</text>
        <input
          v-model="user.email"
          class="h-11 w-full rounded-xl bg-stone-50 px-4 text-sm text-slate-800 outline-none ring-1 ring-slate-200 transition-all focus:bg-white focus:ring-2 focus:ring-amber-400/50"
          type="text"
      ...
      <!-- Sex -->
      <view class="group relative">
        <text class="mb-2 block text-sm font-medium text-slate-700">性别</text>
          ...
          <view
            ...
            :class="
              user.sex === item.value
                ...
                : 'bg-stone-50 border-transparent text-stone-500'
            "
          >
